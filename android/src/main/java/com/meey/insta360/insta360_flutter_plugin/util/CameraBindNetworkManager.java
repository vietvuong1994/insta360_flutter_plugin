...
public class CameraBindNetworkManager {
    ...
    private void registerChildProcessBindNetworkReceiver() {
        ...
        Insta360FlutterPlugin.getInstance().registerReceiver(mOtherProcessBindNetworkReceiver, intentFilter);
    }
    ...
    public void notifyOtherProcessBind(boolean isBind) {
        ...
        Insta360FlutterPlugin.getInstance().sendBroadcast(intent);
    }
        ...
        if (network != null) {
            try {
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                    ...
                    ConnectivityManager connectivityManager = (ConnectivityManager) Insta360FlutterPlugin.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    private Network getWifiNetwork() {
        ConnectivityManager connManager = (ConnectivityManager) Insta360FlutterPlugin.getInstance()
    ...
    private String getProcessName() {
        ...
        ActivityManager manager = (ActivityManager) Insta360FlutterPlugin.getInstance().getSystemService(Context.ACTIVITY_SERVICE);
